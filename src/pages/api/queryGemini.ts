...
export default async function queryGemini(req: NextApiRequest, res: NextApiResponse) {
  ...
  const promptEnding = `Don't just list bulletpoints, collate the data and write a few paragraphs. Don't mention time travel. Make your response at least 250 words, but no more than 300. ${githubUserData}`;
